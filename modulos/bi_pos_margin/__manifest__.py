...
{
    "name" : "POS Margin and Analysis in odoo",
    "version" : "13.0.0.1",
    "depends" : ['base','point_of_sale'],
    "author": "BrowseInfo",
    "summary": "app point of sales Margin on POS product margin on pos margin on pos invoice margin on point of sale margin pos sales margin report pos total margin pos commission pos margin amount pos margin analysis on pos total margin pos order margin on point of sale",
    "description": """
